...
export default function ConnectGitHub(){
  const connect = () => {
    ...
    // Default to localhost in development, but use the current domain in production if VITE_API_BASE is missing
    ...
    // Navigate to the OAuth endpoint, passing the token so the backend knows which user to link
    window.location.href = `${base}/auth/github?token=${token}`;
  }
  return (
